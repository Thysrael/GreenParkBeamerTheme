...
% 声明页
\begin{frame}
  这个 Beamer 主题是基于 \hrefcol{https://github.com/liu-qilong/Beamer-LaTeX-Themes}{Beamer-LaTeX-Themes} 的二次开发，而这个主题是基于 \hrefcol{https://www.overleaf.com/latex/templates/sintef-presentation/jhbhdffczpnx}{SINTEF Presentation} 的二次开发。感谢这些开发者们。
